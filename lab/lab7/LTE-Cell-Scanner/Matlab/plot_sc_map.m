...
for i = 1 : num_sub
    ...
    if sum(sub_sc_map==1)>0
        bar(sc_all(sub_sc_map==1), abs( tfg(i, sub_sc_map==1) ), 'r', 'EdgeColor', 'none', 'BarWidth', 2); axis tight; hold on;
%         bar(sc_all(sub_sc_map==1), abs( tfg(i, sub_sc_map==1) ), 'r', 'linewidth', 0.05); axis tight; hold on;
    ...
    if sum(sub_sc_map==2)>0
        bar(sc_all(sub_sc_map==2), abs( tfg(i, sub_sc_map==2) ), 'g', 'EdgeColor', 'none', 'BarWidth', 2); axis tight; hold on;
%         bar(sc_all(sub_sc_map==2), abs( tfg(i, sub_sc_map==2) ), 'g', 'linewidth', 0.05); axis tight; hold on;
    ...
    if sum(sub_sc_map==3)>0
        bar(sc_all(sub_sc_map==3), abs( tfg(i, sub_sc_map==3) ), 'b', 'EdgeColor', 'none', 'BarWidth', 2); axis tight; hold on;
%         bar(sc_all(sub_sc_map==3), abs( tfg(i, sub_sc_map==3) ), 'b', 'linewidth', 0.05); axis tight; hold on;      
    ...
    if sum(sub_sc_map==4)>0
        bar(sc_all(sub_sc_map==4), abs( tfg(i, sub_sc_map==4) ), 'k', 'EdgeColor', 'none', 'BarWidth', 2); axis tight; hold on;
