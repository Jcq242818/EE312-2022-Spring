...
% companion <matlab:showdemo('zynqRadioWalkieTalkieTransmitterAD9361AD9364ML') Walkie-Talkie
...
% Transmitter Using Analog Devices AD9361/AD9364> MATLAB example
% * The <matlab:showdemo('zynqRadioWalkieTalkieTxAD9361AD9364SL') Walkie-Talkie Transmitter
% Using Analog Devices AD9361/AD9364> Simulink(R) example
...
% <matlab:edit('zynqRadioWalkieTalkieReceiverAD9361AD9364ML.m') zynqRadioWalkieTalkieReceiverAD9361AD9364ML.m>.
%
...
% % rxParams.SDRDeviceName='PicoZed SDR';
...
radio = sdrrx(rxParams.SDRDeviceName,...
...
%
% The CTCSS [ <#22 3> ] decoder computes the power at each CTCSS
% tone frequency using the Goertzel algorithm [ <#22 4> ] and
...
% another device using the Device property of the audio player object,
% _audioPlayer_.
...
%
% The downsample by 40 from 640 kHz to 8 kHz is done in software using a
% <matlab:doc('dsp.FIRDecimator') dsp.FIRDecimator> object,
% _softwareDecimator_. The radio baseband
% rate of 640 kHz is used for two reasons:
%
...
% <matlab:edit('zynqRadioWalkieTalkieReceiverAD9361AD9364ML')
% zynqRadioWalkieTalkieReceiverAD9361AD9364ML.m>. Some possible modifications include:
%
...
% <matlab:showdemo('zynqRadioWalkieTalkieRxAD9361AD9364SL') Walkie-Talkie Receiver Using Analog Devices AD9361/AD9364 using Simulink> example.
...
% signal is too weak.
% * Try varying the gain of the _radio_ object depending on your
...
% an RF frequency.
% * <matlab:edit('zynqRadioWalkieTalkieReceiverHelperAD9361AD9364ML_init.m')
% zynqRadioWalkieTalkieReceiverHelperAD9361AD9364ML_init.m>: get a structure of parameters
