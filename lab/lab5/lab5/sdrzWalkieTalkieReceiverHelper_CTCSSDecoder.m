classdef sdrzWalkieTalkieReceiverHelper_CTCSSDecoder < matlab.System
%sdrzWalkieTalkieReceiverHelper_CTCSSDecoder CTCSS decoder for walkie-talkie receiver example
%   H = sdrzWalkieTalkieReceiverHelper_CTCSSDecoder creates a CTCSS code
%   decoder System object, H. This object determines uses the Goertzel
%   algorithm to determine which tone was sent.
%
%   H = sdrzWalkieTalkieReceiverHelper_CTCSSDecoder(Name,Value) creates a
%   CTCSS decoder object, H, with the specified property Name set to the
...
%               31  192.8
%
%   sdrzWalkieTalkieReceiverHelper_CTCSSDecoder methods:
%
...
%
%   sdrzWalkieTalkieReceiverHelper_CTCSSDecoder properties:
%
%   MinimumBlockLength - Minimum block length in samples
%   SampleRate         - Sample rate in Hz
%
%   See also sdrzWalkieTalkieReceiver.
...
methods
  function obj = sdrzWalkieTalkieReceiverHelper_CTCSSDecoder(varargin)
    %sdrzWalkieTalkieReceiverHelper_CTCSSDecoder Constructor
  ...
  function set.MinimumBlockLength(obj, aLength)
    validateattributes(aLength, {'double', 'single'}, ...
      ...
      'sdrzWalkieTalkieReceiverHelper_CTCSSDecoder', 'MinimumBlockLength');
  ...
  function set.SampleRate(obj, aRate)
    validateattributes(aRate, {'double', 'single'}, ...
      ...
      'sdrzWalkieTalkieReceiverHelper_CTCSSDecoder', 'SampleRate');
