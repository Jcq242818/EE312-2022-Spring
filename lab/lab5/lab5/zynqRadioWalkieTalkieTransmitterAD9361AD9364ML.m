...
% <matlab:showdemo('zynqRadioWalkieTalkieReceiverAD9361AD9364ML') Walkie-Talkie Receiver 
% Using Analog Devices(TM) AD9361/AD9364> example if you have a second SDR platform.
%
...
% Europe. More details on PMR446 can be found in [ <#15 2> ].
%
...
% Receiver Using Analog Devices AD9361/AD9364> MATLAB example
% * The <matlab:showdemo('zynqRadioWalkieTalkieRxAD9361AD9364SL') Walkie-Talkie Receiver with
% Analog Devices AD9361/AD9364> Simulink(R) example
...
% run by executing <matlab:edit('zynqRadioWalkieTalkieTransmitterAD9361AD9364ML.m')
% zynqRadioWalkieTalkieTransmitterAD9361AD9364ML.m>.
%
...
% # Upsample the 8 kHz audio signal to 528 kHz
...
% users to access the same channel simultaneously. CTCSS [ <#15 3> ]
...
%
% See [ <#15 4> ] for more information on frequency modulation.
...
%
% An <matlab:sdrzdoc('commsdrtxzc706fmc23')
% SDR Transmitter> system object is used to send baseband
% data to the SDR hardware. By default, the example is 
...
try
    ...
    while toc < transmissionStopTime
        ...
        droppedSamples = step(hSDRTx,FMModulatedData);
...
%
% The upsample by 32 from 8 kHz to 528 kHz is done in software using a
% <matlab:doc('dsp.FIRInterpolator') dsp.FIRInterpolator> object,
% _softwareInterpolator_. The upsample to
% 528 kHz is used for two reasons:
%
...
% by the SDR hardware baseband rate.
% To make the software sample rates meaningful, the sample rates at the
% software/hardware interface must match. For the AD9361/AD9364, one
...
% <matlab:edit('zynqRadioWalkieTalkieTransmitterAD9361AD9364ML')
% zynqRadioWalkieTalkieTransmitterAD9361AD9364ML.m>. Some possible modifications include:
%
...
% <matlab:showdemo('zynqRadioWalkieTalkieTxAD9361AD9364SL') Walkie-Talkie Transmitter with
% Analog Devices AD9361/AD9364 using Simulink> example.
